...
const LandingFooter = () => {
  return (
    <footer className="mt-4 px-4 mx-0 lg:mx-8">
      <div className="text-center md:text-left">
        <div className="col-12 flex flex-column lg:flex-row text-center justify-content-center align-content-center lg:gap-5">
          ...
          <div className="flex align-items-center justify-content-center gap-5 lg:gap-4">
            ...
            <Link href={'/'} target='_blank' className="p-ripple flex align-items-center m-0 px-0 lg:py-4 text-center text-900 font-medium line-height-3">
            <i className="pi pi-discord text-4xl text-primary-500"></i>
            </Link>
